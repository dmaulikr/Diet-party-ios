...
@interface PostFeedModelRequest : BaseModelRequest
@property (strong, nonatomic) NSString *access_token;
@property (strong, nonatomic) NSString <Optional>*content;
@property (strong, nonatomic) NSString <Optional>*desc; // post type = 1
@property (strong, nonatomic) NSNumber *post_type; //1 = share,2 = food, 3 = excercise
...
@property (strong, nonatomic) NSNumber <Optional>*protien; //post type = 2
...
@property (strong, nonatomic) NSNumber <Optional>*speed; //post type = 2
